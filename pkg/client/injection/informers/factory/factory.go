...
import (
	...
	externalversions "github.com/openshift-knative/knative-eventing-operator/pkg/client/informers/externalversions"
	client "github.com/openshift-knative/knative-eventing-operator/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/openshift-knative/knative-eventing-operator/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
