...
import (
	...
	fake "github.com/openshift-knative/knative-eventing-operator/pkg/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/openshift-knative/knative-eventing-operator/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
